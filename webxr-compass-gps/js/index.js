...
let arrowN = new Gltf2Node({ url: 'media/test/arrow.gltf' });
let arrowE = new Gltf2Node({ url: 'media/test/arrow_blue.gltf' });
let arrowS = new Gltf2Node({ url: 'media/test/arrow_blue.gltf' });
let arrowW = new Gltf2Node({ url: 'media/test/arrow_blue.gltf' });
let firstTime = true;
